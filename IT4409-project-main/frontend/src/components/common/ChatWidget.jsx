...
export default function ChatWidget() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("openOrderChat", openOrderChat);
    return () => window.removeEventListener("openOrderChat", openOrderChat);
  }, []);
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      await sendChatMessage(content, { orderId: activeOrderContext?.orderId });
      const history = await fetchChatHistory();
      setMessages(history);
    } catch (err) {
